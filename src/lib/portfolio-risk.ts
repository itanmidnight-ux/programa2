...
// ============================================
// AnÃ¡lisis de riesgo a nivel de portfolio
// Incluye VaR, drawdown, correlaciÃ³n y lÃ­mites de exposiciÃ³n
// ============================================

import { getAllPrices, POPULAR_PAIRS } from './market-gateway';
