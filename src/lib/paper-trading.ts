...
// Mantiene estado de portfolio virtual y ejecuta seÃ±ales
// ============================================

import { getKlines, getTickerPrice, getOrderBook, get24hTicker } from './market-gateway';
...
export function getPerformanceSummary(): string {
  ...
  lines.push('');
  lines.push('â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ OPEN POSITIONS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€');
