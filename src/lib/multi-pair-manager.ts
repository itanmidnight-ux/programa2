...
import { getBatchPrices, getBatch24hTickers, getAllPrices, DEFAULT_PAIRS, formatPair, unformatPair, type WSPriceUpdate, wsPriceManager, isTestnetMode } from './market-gateway';
...
export class MultiPairManager {
  ...
  /** Start price monitoring (idempotent â€” safe to call multiple times) */
  start(): void {
